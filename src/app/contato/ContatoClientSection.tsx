...
import { MessageCircle, Phone, MapPin, Clock, ExternalLink, Navigation } from "lucide-react";
import { siteConfig } from "@/data/site";
import { CONTACT, ADDRESS, HOURS } from "@/config/siteConfig";
import { trackEvent } from "@/lib/analytics";

export function ContatoClientSection() {
  ...
  const whatsappUrl = `https://wa.me/${CONTACT.whatsapp}?text=${encodeURIComponent(siteConfig.whatsappMessages.contato)}`;
    ...
    <>
      ...
      >
        <div className="container">
          ...
          >
            Agende sua visita pelo WhatsApp, ligue diretamente ou preencha o
            formulário abaixo. Estamos no{" "}
            <strong style={{ color: "#FAF7F4" }}>
              Edifício Mariana, Sala 916, 9º andar
            </strong>
      ...
      {/* Endereço visível em texto — fundamental para SEO local */}
      <section
          ...
          >
            ...
            <div>
              ...
              {status === "success" ? (
                ...
                <form
                  ...
                  noValidate
                  aria-label="Formulário para agendar visita à Puro Charme"
                  ...
                  <div className="form-group">
                    ...
                    >
                      <input
                        ...
                        style={{
                          marginTop: "3px",
                          accentColor: "var(--color-rose-taupe)",
                          flexShrink: 0,
                        }}
                      />
                      Concordo com a{" "}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  <a
                    ...
                    data-page="contato"
                    data-service="geral"
                    aria-label="Abrir conversa no WhatsApp da Puro Charme"
                    style={{
                      display: "flex",
                      alignItems: "center",
                      gap: "1rem",
                  ...
                  <a
                    ...
                    aria-label={`Ligar para a Puro Charme: ${CONTACT.phone}`}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      gap: "1rem",
                  ...
                  <a
                    ...
                    aria-label="Abrir rota para a Puro Charme no Google Maps"
                    style={{
                      display: "flex",
                      alignItems: "center",
                      gap: "1rem",
                  ...
                  <a
                    ...
                    aria-label="Ver perfil da Puro Charme no Instagram"
                    style={{
                      display: "flex",
                      alignItems: "center",
                      gap: "1rem",
              ...
              >
                ...
                >
                  Estamos no{" "}
                  <strong>Edifício Mariana, 9º andar, Sala 916</strong>, na{" "}
                  <strong>Av. Afonso Pena, 526</strong>, Centro de Belo
                  Horizonte. Ao entrar no edifício, suba até o 9º andar e
                  procure a Sala 916. Recomendamos agendar sua visita com
                  antecedência pelo WhatsApp para garantir um atendimento
                  dedicado.
                </p>
              </div>
            </div>
